...
import { normalizeBase, Relay } from './client.js?v=2026-08-05.5';
import { toast } from './components.js?v=2026-08-05.5';
import { $, $$, attachImageFallbacks, debounce, esc, escAttr, formatMoney, REGIONS, scrollToTop, setMediaProxy } from './util.js?v=2026-08-05.5';
...
export const CLIENT_BUILD = CONFIG.build || '2026-08-05.5';
